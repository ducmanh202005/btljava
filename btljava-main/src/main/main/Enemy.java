...
/**
 * Enemy - UPDATED với wave-specific images và bullets
 */
public class Enemy {
    private int x, y;
    ...
    private void shootNormalPattern(List<Bullet> enemyBullets) {
        ...
        if (numBullets == 1) {
            Bullet bullet = new Bullet(bulletX, bulletY, 1, damage, level, isBoss);
            bullet.setSpeed(bulletSpeed);
            enemyBullets.add(bullet);
        } else if (numBullets == 2) {
            Bullet bullet1 = new Bullet(bulletX - 15, bulletY, 1, damage, level, isBoss);
            Bullet bullet2 = new Bullet(bulletX + 15, bulletY, 1, damage, level, isBoss);
            bullet1.setSpeed(bulletSpeed);
            bullet2.setSpeed(bulletSpeed);
            enemyBullets.add(bullet1);
            enemyBullets.add(bullet2);
        } else {
            Bullet bullet1 = new Bullet(bulletX - 20, bulletY, 1, damage, level, isBoss);
            Bullet bullet2 = new Bullet(bulletX, bulletY, 1, damage, level, isBoss);
            Bullet bullet3 = new Bullet(bulletX + 20, bulletY, 1, damage, level, isBoss);
            bullet1.setSpeed(bulletSpeed);
            bullet2.setSpeed(bulletSpeed);
    ...
    /**
     * ★ UPDATED: Boss bắn circular với wave info
     */
    private void shootCircularPattern(List<Bullet> enemyBullets) {
        ...
        for (int i = 0; i < numBullets; i++) {
            ...
            Bullet bullet = new Bullet(bulletX, bulletY, 1, damage, level, true);
    ...
    /**
     * ★ UPDATED: Vẽ enemy/boss với hình ảnh theo wave
     */
    public void draw(Graphics2D g2d) {
        ...
        if (type == EnemyType.BOSS) {
            ...
            img = Assets.getEnemyImage(level);
